...
function platformBadgeClass(platform: VideoPlatform): string {
  switch (platform) {
    case "youtube":
      return "bg-red-700/85 text-white";
    case "instagram":
      return "bg-gradient-to-r from-purple-700/90 to-pink-600/90 text-white";
    case "tiktok":
      return "bg-zinc-900/90 text-white ring-1 ring-white/25";
    case "mux":
      return "bg-indigo-600/85 text-white";
    case "hosted":
      return "bg-zinc-200/90 text-zinc-900";
    default:
      return "bg-zinc-700/90 text-zinc-100";
  }
}
...
export function VideoCard({ video }: { video: Video }) {
  ...
  return (
    <article className="panel-subtle flex h-full flex-col overflow-hidden">
      <div className="relative aspect-video bg-night-elevated/80">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-4 mt-auto pt-2">
          <a
            ...
            className="ui-btn-primary inline-flex w-full items-center justify-center px-4 py-2.5 text-center"
          >
            {watchLabel}
          </a>
        </div>
